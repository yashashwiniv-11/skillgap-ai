          ...
          <Card className="shadow-xl border-0">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Your last 10 analyses</CardDescription>
              </div>
              {history.length > 0 && (
                  ...
                  {categoryStats.map((cat) => (
                    <div key={cat.name} className="space-y-1">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-slate-500">{cat.count} skills</span>
                      </div>
        ...
        {gapResult && (
          <div className="space-y-6">
            ...
            {gapResult.learning_path.length > 0 && (
              <Card className="shadow-xl border-0">
                <CardHeader>
                  ...
                  <CardDescription>Recommended resources for your missing skills</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    {gapResult.learning_path.map((item, index) => (
                      <div key={index} className="p-4 rounded-xl bg-indigo-50 border border-indigo-100">
            ...
            {(jobsLoading || jobs.length > 0) && (
              <Card className="shadow-xl border-0">
                <CardHeader>
                  <CardTitle className="text-blue-600">Recommended Jobs</CardTitle>
                  <CardDescription>Job openings matching your target role</CardDescription>
                </CardHeader>
                <CardContent>
                  {jobsLoading ? (
                    ...
                    <div className="space-y-4">
                      {jobs.map((job, index) => (
                        <div
                          key={index}
                          className="p-4 rounded-xl border border-blue-100 bg-blue-50/50 hover:bg-blue-50 transition"
                        >
